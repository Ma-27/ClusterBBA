# -*- coding: utf-8 -*-
"""test_b_divergence.py

使用 ``b_divergence`` 计算 B 散度矩阵并验证度量性质。
在项目根目录运行：
    python test_b_divergence.py [Example_3_3.csv]
"""
...
# 依赖本项目内现成工具函数 / 模块
from divergence.b_divergence import divergence_matrix, save_csv  # type: ignore
...
if __name__ == '__main__':
    ...
    print(f"结果 CSV: experiments_result/b_divergence_{os.path.splitext(csv_name)[0]}.csv")
